        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="flex space-x-2 mt-6">
              <a  href="https://www.facebook.com/profile.php?id=61580098041355" className="w-10 h-10 border border-gray-600 rounded flex items-center justify-center hover:bg-blue-800 transition-colors">
              ...
              <a href="https://www.linkedin.com/company/106438703/admin/dashboard/" className="w-10 h-10 border border-gray-600 rounded flex items-center justify-center hover:bg-blue-800 transition-colors">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
