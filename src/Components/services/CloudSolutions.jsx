          ...
          <div className="flex flex-col md:flex-row gap-12 items-center">
            ...
            <div className="md:w-1/2">
              <div className="bg-white bg-opacity-10 p-4 rounded-xl shadow-2xl">
                <img src="https://i.pinimg.com/736x/d6/f3/8e/d6f38e454c98dce513010ce926f7c4e0.jpg" alt="Cloud Solutions" className="rounded-lg w-full" />
              </div>
            </div>
          </div>
        </div>
            ...
            {[
              {
                ...
                image: "https://i.pinimg.com/736x/4e/b8/06/4eb806909f35eaee71704eddad262ccb.jpg"
              },
              {
                title: "E-Commerce",
